...
class BD{
    ...
    gravar(d, id){
        ...
        // parametros do método de localStorages
        //passando identificacao do que vamos armazenar
        // dado que vamos armazenar em JASON
        localStorage.setItem(id, JSON.stringify(d)) 
        // JSON.stringify traduz o obj literal para JSON e JSON.parse traduz o JSON para obj literal
    ...
    recuperarTodosRegistros(){
        ...
        //rec todas as despesas no local Storge
        for (let i = 1; i <= id; i++){

            let despesa = JSON.parse(localStorage.getItem(i))

            // existe a possibilidade de haver indices removidos ou que foram pulados 
...
function carregaListaDespesas (despesas = Array(), filtro = false){
    ...
    */
    ...
    // percorrer das despesas, listando cada despesa de forma dinâmica
    despesas.forEach(function(d){
        ...
        //criar colunas td
        linha.insertCell(0).innerHTML = `${d.dia}/${d.mes}/${d.ano}` // OUUUU d.dia + '/' +d.mes+ '/' + d.ano
